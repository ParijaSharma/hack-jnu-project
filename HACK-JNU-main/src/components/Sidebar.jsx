...
const Sidebar = ({ collapsed, onToggle, onViewProfile, onNavigate,activePage }) => {
  const [showProfileMenu, setShowProfileMenu] = useState(false)
  const profileMenuRef = useRef(null)

  const menuItems = [
  { icon: FiHome, label: 'home', title: 'Home' },
  { icon: FiLayout, label: 'dashboard', title: 'Dashboard' },
  { icon: FiMessageSquare, label: 'chat', title: 'New Chat' },
];
